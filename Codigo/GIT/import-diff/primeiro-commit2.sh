	...
	while read -r linha || [[ -n "$linha" ]]
		do	
			...
			if [ $? -ne 0 ]; then
				...
				echo "$linhaL" > $dir/FirstImport/BOTTOM/aux2.txt
				ultimaL=$(tail -1 "$dir/FirstImport/BOTTOM/aux2.txt") #>> $dir/FirstImport/$filtro1.txt
				...
				echo "$1, $primeiro, $resto" >> $dir/FirstImport/BOTTOM/$filtro1.txt
		...
		rm $dir/FirstImport/BOTTOM/aux2.txt
